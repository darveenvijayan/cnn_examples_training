...
class AlexNetDataset(object):
    def __init__(self, root, transforms):
        ...
        for my_class in classes:
	        n = os.listdir(os.path.join(root, my_class))
        ...
        for i, my_class in enumerate(classes):
	        self.imgs.extend(os.listdir(os.path.join(root, my_class))[:n_class])
	        self.labels_idx.append([i] * n_class)
